        ...
        if (String.valueOf(new JSONObject(response).getString("msg")).equals("Data Semua Search")) {
          try {
            ...
            searchEbookGetCallback
                .onSuccesSearchEbook(pojoEbook.getEbook(), context.getString(R.string.text_succes));
          } catch (Exception e) {
            e.printStackTrace();
          }
        } else {
          searchEbookGetCallback.onWrongSearchEbook(context.getString(R.string.text_error));
        }
